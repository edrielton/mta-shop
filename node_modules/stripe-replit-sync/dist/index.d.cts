...
declare class StripeSync {
    ...
    processWebhook(payload: Buffer | string, signature: string | undefined, uuid?: string): Promise<void>;
    ...
    createManagedWebhook(baseUrl: string, params: Omit<Stripe.WebhookEndpointCreateParams, 'url'>): Promise<{
        webhook: Stripe.WebhookEndpoint;
        uuid: string;
    }>;
    findOrCreateManagedWebhook(baseUrl: string, params: Omit<Stripe.WebhookEndpointCreateParams, 'url'>): Promise<{
        webhook: Stripe.WebhookEndpoint;
        uuid: string;
    }>;
    getManagedWebhook(id: string): Promise<(Stripe.WebhookEndpoint & {
        uuid: string;
    }) | null>;
    ...
    upsertManagedWebhooks(webhooks: Array<Stripe.WebhookEndpoint & {
        uuid: string;
    }>, accountId: string, syncTimestamp?: string): Promise<Array<Stripe.WebhookEndpoint & {
        uuid: string;
    }>>;
...
export { type Logger, PostgresClient, type RevalidateEntity, StripeSync, type StripeSyncConfig, type StripeWebSocketClient, type StripeWebSocketOptions, type Sync, type SyncBackfill, type SyncBackfillParams, type SyncEntitlementsParams, type SyncFeaturesParams, type SyncObject, createStripeWebSocketClient, hashApiKey, runMigrations };
