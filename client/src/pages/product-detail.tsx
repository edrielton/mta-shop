...
function getCategoryIcon(category: string) {
  switch (category) {
    ...
    case "coins":
      return <Coins className="h-12 w-12" />;
    default:
        ...
        <div className="grid lg:grid-cols-2 gap-8 lg:gap-12">
          ...
          <div className="relative aspect-square bg-gradient-to-br from-muted to-muted/50 rounded-lg flex items-center justify-center">
            ...
            {product.category === "vip" && (
              <Badge className="absolute top-4 right-4 bg-amber-500 text-white px-4 py-1">
                POPULAR
              </Badge>
            )}
          </div>
          ...
          <div>
            <div className="mb-6">
              <Badge
                variant="secondary"
                className={`mb-4 ${getCategoryColor(product.category)}`}
              >
            ...
            <div className="space-y-3 mb-8">
              ...
              <div className="flex items-center gap-3 text-sm">
                ...
                <span>Entrega instantânea após pagamento</span>
              </div>
              <div className="flex items-center gap-3 text-sm">
                ...
                <AccordionContent>
                  <div className="space-y-4 text-muted-foreground">
                    <div>
                      ...
                      <p>A ativação é instantânea após a confirmação do pagamento.</p>
                    </div>
                    <div>
